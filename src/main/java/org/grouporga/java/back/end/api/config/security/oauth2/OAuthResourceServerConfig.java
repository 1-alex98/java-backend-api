...
public class OAuthResourceServerConfig extends ResourceServerConfigurerAdapter {
  ...
  @Inject
  public OAuthResourceServerConfig(OrgaProperties orgaProperties, ResourceServerTokenServices tokenServices) {
    this.resourceId = orgaProperties.getOAuth2().getResourceId();
